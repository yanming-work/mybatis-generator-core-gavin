...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean selectByPageExampleStatementEnabled;
    
    private boolean  saveOrUpdateByExampleStatementEnabled;
    
    private boolean  updateBatchByPrimaryKeyStatementEnabled;
    
    private boolean  saveOrUpdateByPrimaryKeyStatementEnabled;
    
    private boolean insertBatchStatementEnabled;
    private boolean insertBatchSelectiveStatementEnabled;
    
    private String  selectByPageExampleQueryId;
    
    private String  saveOrUpdateByExampleQueryId;

    
    private String  updateBatchByPrimaryKeyQueryId;
    
    private String  saveOrUpdateByPrimaryKeyQueryId;
    ...
    public TableConfiguration(Context context) {
        ...
        selectByPageExampleStatementEnabled=true;
        insertBatchStatementEnabled=true;
        insertBatchSelectiveStatementEnabled=true;
        saveOrUpdateByExampleStatementEnabled=true;
        updateBatchByPrimaryKeyStatementEnabled=true;
        saveOrUpdateByPrimaryKeyStatementEnabled=true;
    ...
    public boolean isSelectByPageExampleStatementEnabled() {
        return selectByPageExampleStatementEnabled;
    }
    ...
    public void setSelectByPageExampleStatementEnabled(
            boolean selectByPageExampleStatementEnabled) {
        this.selectByPageExampleStatementEnabled = selectByPageExampleStatementEnabled;
    }
    ...
    public boolean areAnyStatementsEnabled() {
        return selectByExampleStatementEnabled
                ...
                || updateByExampleStatementEnabled||selectByPageExampleStatementEnabled||insertBatchStatementEnabled||insertBatchSelectiveStatementEnabled||saveOrUpdateByExampleStatementEnabled;
    }
    ...
    public XmlElement toXmlElement() {
        ...
        if (!selectByPageExampleStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableSelectByPageExample", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        ...
        if (!insertBatchStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableInsertBatch", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        
        if (!insertBatchSelectiveStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableInsertBatchSelective", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        ...
        if (!saveOrUpdateByExampleStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableSaveOrUpdateByExample", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        if (!updateBatchByPrimaryKeyStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableUpdateBatchByPrimaryKey", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        if (!saveOrUpdateByPrimaryKeyStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableSaveOrUpdateByPrimaryKey", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        ...
        if (stringHasValue(saveOrUpdateByExampleQueryId)) {
            xmlElement.addAttribute(new Attribute(
                    "saveOrUpdateByExampleQueryId", saveOrUpdateByExampleQueryId)); //$NON-NLS-1$
        }
        if (stringHasValue(updateBatchByPrimaryKeyQueryId)) {
            xmlElement.addAttribute(new Attribute(
                    "updateBatchByPrimaryKeyQueryId", updateBatchByPrimaryKeyQueryId)); //$NON-NLS-1$
        }
        if (stringHasValue(saveOrUpdateByPrimaryKeyQueryId)) {
            xmlElement.addAttribute(new Attribute(
                    "saveOrUpdateByPrimaryKeyQueryId", saveOrUpdateByPrimaryKeyQueryId)); //$NON-NLS-1$
        }
    ...
    public void validate(List<String> errors, int listPosition) {
        ...
        if (isTrue(getProperty(PropertyRegistry.TABLE_USE_COLUMN_INDEXES))
                ...
                && selectByPrimaryKeyStatementEnabled &&selectByPageExampleStatementEnabled) {
	...
	public boolean isInsertBatchSelectiveStatementEnabled() {
		return insertBatchSelectiveStatementEnabled;
	}

	public void setInsertBatchSelectiveStatementEnabled(boolean insertBatchSelectiveStatementEnabled) {
		this.insertBatchSelectiveStatementEnabled = insertBatchSelectiveStatementEnabled;
	}
    
	 public String getSelectByPageExampleQueryId() {
			return selectByPageExampleQueryId;
		}

		public void setSelectByPageExampleQueryId(String selectByPageExampleQueryId) {
			this.selectByPageExampleQueryId = selectByPageExampleQueryId;
		}

		 
		
		
		public boolean isSaveOrUpdateByExampleStatementEnabled() {
			return saveOrUpdateByExampleStatementEnabled;
		}

		public void setSaveOrUpdateByExampleStatementEnabled(boolean saveOrUpdateByExampleStatementEnabled) {
			this.saveOrUpdateByExampleStatementEnabled = saveOrUpdateByExampleStatementEnabled;
		}

		public String getSaveOrUpdateByExampleQueryId() {
			return saveOrUpdateByExampleQueryId;
		}

		public void setSaveOrUpdateByExampleQueryId(String saveOrUpdateByExampleQueryId) {
			this.saveOrUpdateByExampleQueryId = saveOrUpdateByExampleQueryId;
		}

		public boolean isUpdateBatchByPrimaryKeyStatementEnabled() {
			return updateBatchByPrimaryKeyStatementEnabled;
		}

		public void setUpdateBatchByPrimaryKeyStatementEnabled(boolean updateBatchByPrimaryKeyStatementEnabled) {
			this.updateBatchByPrimaryKeyStatementEnabled = updateBatchByPrimaryKeyStatementEnabled;
		}

		public boolean isSaveOrUpdateByPrimaryKeyStatementEnabled() {
			return saveOrUpdateByPrimaryKeyStatementEnabled;
		}

		public void setSaveOrUpdateByPrimaryKeyStatementEnabled(boolean saveOrUpdateByPrimaryKeyStatementEnabled) {
			this.saveOrUpdateByPrimaryKeyStatementEnabled = saveOrUpdateByPrimaryKeyStatementEnabled;
		}

		public String getUpdateBatchByPrimaryKeyQueryId() {
			return updateBatchByPrimaryKeyQueryId;
		}

		public void setUpdateBatchByPrimaryKeyQueryId(String updateBatchByPrimaryKeyQueryId) {
			this.updateBatchByPrimaryKeyQueryId = updateBatchByPrimaryKeyQueryId;
		}

		public String getSaveOrUpdateByPrimaryKeyQueryId() {
			return saveOrUpdateByPrimaryKeyQueryId;
		}

		public void setSaveOrUpdateByPrimaryKeyQueryId(String saveOrUpdateByPrimaryKeyQueryId) {
			this.saveOrUpdateByPrimaryKeyQueryId = saveOrUpdateByPrimaryKeyQueryId;
		}
