...
public class JavaBeansUtil {
    ...
    public static Field getJavaBeansCountField() {
    	Field field = new Field();
        field.setVisibility(JavaVisibility.PRIVATE);
    ...
    public static Method getJavaBeansCountGetter() {
        
        Method method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setReturnType(new FullyQualifiedJavaType("long"));
        method.setName(getGetterMethodName("count", new FullyQualifiedJavaType("long")));
    ...
    public static Method getJavaBeansCountSetter() {
      

        Method method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName(getSetterMethodName("count"));
        method.addParameter(new Parameter(new FullyQualifiedJavaType("long"), "count"));
