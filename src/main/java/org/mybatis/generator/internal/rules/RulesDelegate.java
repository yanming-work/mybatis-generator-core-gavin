...
public class RulesDelegate implements Rules {
    ...
    public boolean generateSaveOrUpdateByExampleWithBLOBs() {
        return rules.generateSaveOrUpdateByExampleWithBLOBs();
    }

    @Override
    public boolean generateSaveOrUpdateByExampleWithoutBLOBs() {
        return rules.generateSaveOrUpdateByExampleWithoutBLOBs();
    }
    ...
    public boolean generateUpdateBatchByPrimaryKeyWithBLOBs() {
        return rules.generateUpdateBatchByPrimaryKeyWithBLOBs();
    }

    @Override
    public boolean generateUpdateBatchByPrimaryKeyWithoutBLOBs() {
        return rules.generateUpdateBatchByPrimaryKeyWithoutBLOBs();
    }
    ...
    public boolean generateSaveOrUpdateByPrimaryKeyWithBLOBs() {
        return rules.generateSaveOrUpdateByPrimaryKeyWithBLOBs();
    }

    @Override
    public boolean generateSaveOrUpdateByPrimaryKeyWithoutBLOBs() {
        return rules.generateSaveOrUpdateByPrimaryKeyWithoutBLOBs();
    }
}
