...
public abstract class BaseRules implements Rules {
    ...
    public boolean generateExampleClass() {
        ...
        boolean rc = tableConfiguration.isSelectByExampleStatementEnabled()
                ...
                || tableConfiguration.isUpdateByExampleStatementEnabled()
                || tableConfiguration.isUpdateByExampleStatementEnabled()
                || tableConfiguration.isSelectByPageExampleStatementEnabled()
                || tableConfiguration.isSaveOrUpdateByExampleStatementEnabled()
                || tableConfiguration.isUpdateBatchByPrimaryKeyStatementEnabled()
                || tableConfiguration.isSaveOrUpdateByPrimaryKeyStatementEnabled();
    ...
    @Override
    public boolean generateSelectByPageExampleWithoutBLOBs() {
        if (isModelOnly) {
            return false;
        }

        return tableConfiguration.isSelectByPageExampleStatementEnabled();
    }

  
    @Override
    public boolean generateSelectByPageExampleWithBLOBs() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isSelectByPageExampleStatementEnabled()
                && introspectedTable.hasBLOBColumns();
    ...
    @Override
    public boolean generateSaveOrUpdateByExampleWithoutBLOBs() {
        if (isModelOnly) {
            return false;
        }

        return tableConfiguration.isSaveOrUpdateByExampleStatementEnabled();
    }

  
    @Override
    public boolean generateSaveOrUpdateByExampleWithBLOBs() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isSaveOrUpdateByExampleStatementEnabled()
                && introspectedTable.hasBLOBColumns();
    ...
    @Override
    public boolean generateUpdateBatchByPrimaryKeyWithoutBLOBs() {
        if (isModelOnly) {
            return false;
        }

        return tableConfiguration.isUpdateBatchByPrimaryKeyStatementEnabled();
    }

  
    @Override
    public boolean generateUpdateBatchByPrimaryKeyWithBLOBs() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isUpdateBatchByPrimaryKeyStatementEnabled()
                && introspectedTable.hasBLOBColumns();
    ...
    @Override
    public boolean generateSaveOrUpdateByPrimaryKeyWithoutBLOBs() {
        if (isModelOnly) {
            return false;
        }

        return tableConfiguration.isSaveOrUpdateByPrimaryKeyStatementEnabled();
    }

  
    @Override
    public boolean generateSaveOrUpdateByPrimaryKeyWithBLOBs() {
        if (isModelOnly) {
            return false;
        }
        
        boolean rc = tableConfiguration.isSaveOrUpdateByPrimaryKeyStatementEnabled()
                && introspectedTable.hasBLOBColumns();
