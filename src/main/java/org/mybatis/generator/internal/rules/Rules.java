...
public interface Rules {
     ...
     */
     ...
     boolean generateSelectByPageExampleWithBLOBs();
     boolean generateSelectByPageExampleWithoutBLOBs();
     
     boolean generateSaveOrUpdateByExampleWithBLOBs();
     boolean generateSaveOrUpdateByExampleWithoutBLOBs();
     
     boolean generateUpdateBatchByPrimaryKeyWithBLOBs();
     boolean generateUpdateBatchByPrimaryKeyWithoutBLOBs();
     
     boolean generateSaveOrUpdateByPrimaryKeyWithBLOBs();
     boolean generateSaveOrUpdateByPrimaryKeyWithoutBLOBs();
}
