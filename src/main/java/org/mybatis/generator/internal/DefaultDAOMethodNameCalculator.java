 ...
 */
    ...
    @Override
    public String getSelectByPageExampleWithoutBLOBsMethodName(
            IntrospectedTable introspectedTable) {
        Rules rules = introspectedTable.getRules();

        if (!rules.generateSelectByPageExampleWithBLOBs()) {
            return "selectByPageExample"; //$NON-NLS-1$
        } else {
            return "selectByPageExampleWithoutBLOBs"; //$NON-NLS-1$
        }
    }
    @Override
    public String getSelectByPageExampleWithBLOBsMethodName(
            IntrospectedTable introspectedTable) {
        Rules rules = introspectedTable.getRules();

        if (!rules.generateSelectByPageExampleWithoutBLOBs()) {
            return "selectByPageExample"; //$NON-NLS-1$
        } else {
            return "selectByPageExampleWithBLOBs"; //$NON-NLS-1$
        }
    }
    ...
    @Override
    public String getSaveOrUpdateByExampleWithoutBLOBsMethodName(
            IntrospectedTable introspectedTable) {
        Rules rules = introspectedTable.getRules();

        if (!rules.generateSaveOrUpdateByExampleWithBLOBs()) {
            return "saveOrUpdateByExample"; //$NON-NLS-1$
        } else {
            return "saveOrUpdateByExampleWithoutBLOBs"; //$NON-NLS-1$
        }
    }
    @Override
    public String getSaveOrUpdateByExampleWithBLOBsMethodName(
            IntrospectedTable introspectedTable) {
        Rules rules = introspectedTable.getRules();

        if (!rules.generateSaveOrUpdateByExampleWithoutBLOBs()) {
            return "saveOrUpdateByExample"; //$NON-NLS-1$
        } else {
            return "saveOrUpdateByExampleWithBLOBs"; //$NON-NLS-1$
        }
    }
    ...
    @Override
    public String getUpdateBatchByPrimaryKeyWithoutBLOBsMethodName(
            IntrospectedTable introspectedTable) {
        Rules rules = introspectedTable.getRules();

        if (!rules.generateUpdateBatchByPrimaryKeyWithBLOBs()) {
            return "updateBatchByPrimaryKey"; //$NON-NLS-1$
        } else {
            return "updateBatchByPrimaryKeyWithoutBLOBs"; //$NON-NLS-1$
        }
    }
    @Override
    public String getUpdateBatchByPrimaryKeyWithBLOBsMethodName(
            IntrospectedTable introspectedTable) {
        Rules rules = introspectedTable.getRules();

        if (!rules.generateUpdateBatchByPrimaryKeyWithoutBLOBs()) {
            return "updateBatchByPrimaryKey"; //$NON-NLS-1$
        } else {
            return "updateBatchByPrimaryKeyWithBLOBs"; //$NON-NLS-1$
        }
    }
    ...
    @Override
    public String getSaveOrUpdateByPrimaryKeyWithoutBLOBsMethodName(
            IntrospectedTable introspectedTable) {
        Rules rules = introspectedTable.getRules();

        if (!rules.generateSaveOrUpdateByPrimaryKeyWithBLOBs()) {
            return "saveOrUpdateByPrimaryKey"; //$NON-NLS-1$
        } else {
            return "saveOrUpdateByPrimaryKeyWithoutBLOBs"; //$NON-NLS-1$
        }
    }
    @Override
    public String getSaveOrUpdateByPrimaryKeyWithBLOBsMethodName(
            IntrospectedTable introspectedTable) {
        Rules rules = introspectedTable.getRules();

        if (!rules.generateSaveOrUpdateByPrimaryKeyWithoutBLOBs()) {
            return "saveOrUpdateByPrimaryKey"; //$NON-NLS-1$
        } else {
            return "saveOrUpdateByPrimaryKeyWithBLOBs"; //$NON-NLS-1$
        }
    }
