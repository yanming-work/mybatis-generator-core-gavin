...
/**
 */
public class InsertBatchSelectiveWithBLOBsElementGenerator extends
        AbstractXmlElementGenerator {

    public InsertBatchSelectiveWithBLOBsElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", introspectedTable.getInsertBatchSelectiveStatementId()+"WithBLOBs")); //$NON-NLS-1$
        ...
        if("oracle".equals(dbName)){
       	 valuesTrimElement.addAttribute(new Attribute("prefix", " SELECT   ")); 
            valuesTrimElement.addAttribute(new Attribute("suffix", "  FROM DUAL  ")); 
