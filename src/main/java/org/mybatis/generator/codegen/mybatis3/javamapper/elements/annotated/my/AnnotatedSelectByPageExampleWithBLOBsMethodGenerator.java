...
public class AnnotatedSelectByPageExampleWithBLOBsMethodGenerator extends SelectByPageExampleWithBLOBsMethodGenerator {

    public AnnotatedSelectByPageExampleWithBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getSelectByPageExampleWithBLOBsStatementId());
        sb.append("\")"); //$NON-NLS-1$
