...
public class ProviderSelectByPageExampleWithoutBLOBsMethodGenerator  extends AbstractJavaProviderMethodGenerator {

    public ProviderSelectByPageExampleWithoutBLOBsMethodGenerator(boolean useLegacyBuilder) {
    ...
    public String getMethodName() {
        return introspectedTable.getSelectByPageExampleStatementId();
    }

    public boolean callPlugins(Method method, TopLevelClass topLevelClass) {
        return context.getPlugins().providerSelectByPageExampleWithoutBLOBsMethodGenerated(method, topLevelClass,
                introspectedTable);
    }
}
