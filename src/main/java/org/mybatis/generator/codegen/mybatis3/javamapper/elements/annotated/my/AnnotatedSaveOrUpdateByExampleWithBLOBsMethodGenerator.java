...
public class AnnotatedSaveOrUpdateByExampleWithBLOBsMethodGenerator extends SaveOrUpdateByExampleWithBLOBsMethodGenerator {

    public AnnotatedSaveOrUpdateByExampleWithBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getSaveOrUpdateByExampleWithBLOBsStatementId());
        sb.append("\")"); //$NON-NLS-1$
