...
public class AnnotatedUpdateBatchByPrimaryKeyWithoutBLOBsMethodGenerator  extends UpdateBatchByPrimaryKeyWithoutBLOBsMethodGenerator {

    public AnnotatedUpdateBatchByPrimaryKeyWithoutBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getUpdateBatchByPrimaryKeyStatementId());
        sb.append("\")"); //$NON-NLS-1$
