...
public class ProviderUpdateBatchByPrimaryKeyWithoutBLOBsMethodGenerator  extends AbstractJavaProviderMethodGenerator {

    public ProviderUpdateBatchByPrimaryKeyWithoutBLOBsMethodGenerator(boolean useLegacyBuilder) {
    ...
    public String getMethodName() {
        return introspectedTable.getUpdateBatchByPrimaryKeyStatementId();
    }

    public boolean callPlugins(Method method, TopLevelClass topLevelClass) {
        return context.getPlugins().providerUpdateBatchByPrimaryKeyWithoutBLOBsMethodGenerated(method, topLevelClass,
                introspectedTable);
    }
}
