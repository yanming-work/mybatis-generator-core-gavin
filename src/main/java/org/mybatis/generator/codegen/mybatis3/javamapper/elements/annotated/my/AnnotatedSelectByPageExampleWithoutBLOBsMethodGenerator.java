...
public class AnnotatedSelectByPageExampleWithoutBLOBsMethodGenerator  extends SelectByPageExampleWithoutBLOBsMethodGenerator {

    public AnnotatedSelectByPageExampleWithoutBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getSelectByPageExampleStatementId());
        sb.append("\")"); //$NON-NLS-1$
