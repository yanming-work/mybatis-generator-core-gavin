 ...
 * 
 */
public class InsertSelectiveWithBLOBsElementGenerator extends
        AbstractXmlElementGenerator {

    public InsertSelectiveWithBLOBsElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", introspectedTable.getInsertSelectiveStatementId()+"WithBLOBs")); //$NON-NLS-1$
