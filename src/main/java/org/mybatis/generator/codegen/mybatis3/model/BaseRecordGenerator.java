...
import static org.mybatis.generator.internal.util.JavaBeansUtil.getJavaBeansCountField;
import static org.mybatis.generator.internal.util.JavaBeansUtil.getJavaBeansCountGetter;
import static org.mybatis.generator.internal.util.JavaBeansUtil.getJavaBeansCountSetter;
...
public class BaseRecordGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        //自定义，新增count
        Field field =   getJavaBeansCountField();
        topLevelClass.addField(field);
        topLevelClass.addImportedType(field.getType());
        Method methodget = getJavaBeansCountGetter();
        topLevelClass.addMethod(methodget);
        Method methodset = getJavaBeansCountSetter();
