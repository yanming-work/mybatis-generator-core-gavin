...
public class AnnotatedUpdateBatchByPrimaryKeyWithBLOBsMethodGenerator extends UpdateBatchByPrimaryKeyWithBLOBsMethodGenerator {

    public AnnotatedUpdateBatchByPrimaryKeyWithBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getUpdateBatchByPrimaryKeyWithBLOBsStatementId());
        sb.append("\")"); //$NON-NLS-1$
