...
public class AnnotatedSaveOrUpdateByPrimaryKeyWithoutBLOBsMethodGenerator  extends SaveOrUpdateByPrimaryKeyWithoutBLOBsMethodGenerator {

    public AnnotatedSaveOrUpdateByPrimaryKeyWithoutBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getSaveOrUpdateByPrimaryKeyStatementId());
        sb.append("\")"); //$NON-NLS-1$
