...
public class SaveOrUpdateByPrimaryKeyWithBLOBsElementGenerator extends AbstractXmlElementGenerator  {

	public SaveOrUpdateByPrimaryKeyWithBLOBsElementGenerator( ) {
        super();
    }
	@Override
	public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", //$NON-NLS-1$
                introspectedTable.getSaveOrUpdateByPrimaryKeyWithBLOBsStatementId()));
		...
		if (context.getPlugins().sqlMapSaveOrUpdateByExampleWithBLOBsElementGenerated(answer, introspectedTable)) {
