 ...
 * 
 */
public class InsertWithBLOBsElementGenerator extends AbstractXmlElementGenerator {


    public InsertWithBLOBsElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", introspectedTable.getInsertStatementId()+"WithBLOBs")); //$NON-NLS-1$
