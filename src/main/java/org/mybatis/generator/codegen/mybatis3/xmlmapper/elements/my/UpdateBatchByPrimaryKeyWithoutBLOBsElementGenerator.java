...
public class UpdateBatchByPrimaryKeyWithoutBLOBsElementGenerator extends AbstractXmlElementGenerator {
	 private boolean isSimple;
	public UpdateBatchByPrimaryKeyWithoutBLOBsElementGenerator(boolean isSimple) {
		super();
	...
	public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", //$NON-NLS-1$
                introspectedTable.getUpdateBatchByPrimaryKeyStatementId()));
		...
		if (context.getPlugins().sqlMapUpdateBatchByPrimaryKeyWithoutBLOBsElementGenerated(answer, introspectedTable)) {
