...
public class AnnotatedSaveOrUpdateByExampleWithoutBLOBsMethodGenerator  extends SaveOrUpdateByExampleWithoutBLOBsMethodGenerator {

    public AnnotatedSaveOrUpdateByExampleWithoutBLOBsMethodGenerator() {
        super();
    }
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(introspectedTable.getSaveOrUpdateByExampleStatementId());
        sb.append("\")"); //$NON-NLS-1$
