...
public class SelectByPageExampleWithBLOBsElementGenerator extends AbstractXmlElementGenerator  {

	
	public SelectByPageExampleWithBLOBsElementGenerator() {
        super();
    }
	 @Override
	    public void addElements(XmlElement parentElement) {
	        ...
	        answer
	                .addAttribute(new Attribute(
	                        "id", introspectedTable.getSelectByPageExampleWithBLOBsStatementId())); //$NON-NLS-1$
	        ...
	        if (context.getPlugins()
	                .sqlMapSelectByPageExampleWithBLOBsElementGenerated(answer,
	                        introspectedTable)) {
