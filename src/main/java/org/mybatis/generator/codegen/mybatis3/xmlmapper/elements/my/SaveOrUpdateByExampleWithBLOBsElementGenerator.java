...
public class SaveOrUpdateByExampleWithBLOBsElementGenerator extends AbstractXmlElementGenerator  {

	public SaveOrUpdateByExampleWithBLOBsElementGenerator( ) {
        super();
    }
	@Override
	public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", //$NON-NLS-1$
                introspectedTable.getSaveOrUpdateByExampleWithBLOBsStatementId()));
