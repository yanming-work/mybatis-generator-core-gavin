...
/**
 */
public class InsertBatchWithBLOBsElementGenerator extends AbstractXmlElementGenerator {


    public InsertBatchWithBLOBsElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", introspectedTable.getInsertBatchStatementId()+"WithBLOBs")); //$NON-NLS-1$
