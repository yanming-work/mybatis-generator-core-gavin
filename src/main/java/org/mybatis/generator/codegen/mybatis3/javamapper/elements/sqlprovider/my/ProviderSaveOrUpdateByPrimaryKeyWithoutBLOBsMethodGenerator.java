...
public class ProviderSaveOrUpdateByPrimaryKeyWithoutBLOBsMethodGenerator  extends AbstractJavaProviderMethodGenerator {

    public ProviderSaveOrUpdateByPrimaryKeyWithoutBLOBsMethodGenerator(boolean useLegacyBuilder) {
    ...
    public String getMethodName() {
        return introspectedTable.getSaveOrUpdateByPrimaryKeyStatementId();
    }

    public boolean callPlugins(Method method, TopLevelClass topLevelClass) {
        return context.getPlugins().providerSaveOrUpdateByPrimaryKeyWithoutBLOBsMethodGenerated(method, topLevelClass,
                introspectedTable);
    }
}
