 ...
 * 
 */
public class SelectByPrimaryKeyWithBLOBsElementGenerator extends
        AbstractXmlElementGenerator {

    public SelectByPrimaryKeyWithBLOBsElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", introspectedTable.getSelectByPrimaryKeyStatementId()+"WithBLOBs")); //$NON-NLS-1$
