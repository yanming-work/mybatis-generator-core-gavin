...
import org.mybatis.generator.codegen.ibatis2.dao.elements.my.SelectByPageExampleGeneratorMethod;
import org.mybatis.generator.codegen.ibatis2.dao.elements.my.SelectByPageExampleWithBLOBsMethodGenerator;
import org.mybatis.generator.codegen.ibatis2.dao.elements.my.SelectByPageExampleWithoutBLOBsMethodGenerator;
...
public class DAOGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addSelectByPageExampleWithBLOBsMethod(topLevelClass, interfaze);
        addSelectByPageExampleWithoutBLOBsMethod(topLevelClass, interfaze);
    ...
    protected void addSelectByPageExampleWithBLOBsMethod(
            TopLevelClass topLevelClass, Interface interfaze) {
        if (introspectedTable.getRules().generateSelectByPageExampleWithBLOBs()) {
            AbstractDAOElementGenerator methodGenerator =
                    new SelectByPageExampleWithBLOBsMethodGenerator(generateForJava5);
            initializeAndExecuteGenerator(methodGenerator, topLevelClass,
                    interfaze);
        }
    }

    protected void addSelectByPageExampleWithoutBLOBsMethod(
            TopLevelClass topLevelClass, Interface interfaze) {
        if (introspectedTable.getRules().generateSelectByPageExampleWithoutBLOBs()) {
            AbstractDAOElementGenerator methodGenerator =
                    new SelectByPageExampleWithoutBLOBsMethodGenerator(generateForJava5);
            initializeAndExecuteGenerator(methodGenerator, topLevelClass,
                    interfaze);
        }
    }
