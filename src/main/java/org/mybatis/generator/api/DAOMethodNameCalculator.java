...
public interface DAOMethodNameCalculator {
    ...
    String getSelectByPageExampleWithoutBLOBsMethodName(
            IntrospectedTable introspectedTable);
    
    String getSelectByPageExampleWithBLOBsMethodName(
            IntrospectedTable introspectedTable);
    
    
    
    String getSaveOrUpdateByExampleWithoutBLOBsMethodName(
            IntrospectedTable introspectedTable);
    
    String getSaveOrUpdateByExampleWithBLOBsMethodName(
            IntrospectedTable introspectedTable);
    
    

    String getUpdateBatchByPrimaryKeyWithoutBLOBsMethodName(
            IntrospectedTable introspectedTable);
    
    String getUpdateBatchByPrimaryKeyWithBLOBsMethodName(
            IntrospectedTable introspectedTable);
    

    String getSaveOrUpdateByPrimaryKeyWithoutBLOBsMethodName(
            IntrospectedTable introspectedTable);
    
    String getSaveOrUpdateByPrimaryKeyWithBLOBsMethodName(
            IntrospectedTable introspectedTable);
